...
const inputHandler = () => {
  ...
  //determine number of characters currently types
  const nrCharsTyped = textareaEl.value.length;

  // calcuate  number of characters left(maximum minus currently typed)
...
const submitHandler = (event) => {
  // prevent default browser aciton (submitting form data to 'action address and refreshing page)
  ...
  // we have text, now extracct other info from text
...
const clickHandler = (event) => {
  ...
  if (upvoteIntention) {
    ...
    // diable upvote button (prevent double-clicks, spam)
